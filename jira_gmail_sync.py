...
# Gmail config
GMAIL_CREDS_PATH = "gmail_token.json"  # חייב להיות קובץ שנוצר אחרי OAuth
...
def fetch_hp_to_issue():
    ...
    if response.status_code != 200:
        print("שגיאה ב-Jira:", response.status_code)
        print(response.text)
        return {}
...
def main():
    fetch_hp_to_issue()  # משיכת מיפוי ח.פ עדכני ושמירה לקובץ
